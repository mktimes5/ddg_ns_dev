$(function() {
    ...
    $('<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto" media="all">').appendTo('head');

    var deferred = $.Deferred();
    document.fonts.load('100px Gloria Hallelujah').then(function () {
        deferred.resolve();
    });
